...
public class ResearchAdminApprovalFail {
	...
	public void testNewProposal() throws Exception {
		...
		((JavascriptExecutor) driver)
				.executeScript(
						"arguments[0].val‌​ue=arguments[1]",
						driver.findElement(By
								.name("5745fcfdbcbb29192ce0d451University_Research_Administrator")),
						"Research Admin");
		Thread.sleep(500);

		((JavascriptExecutor) driver)
				.executeScript("document.getElementsByName('signaturedate5745fcfdbcbb29192ce0d451University_Research_Administrator').removeAttribute('readonly',0);");
		driver.findElement(
		...
		((JavascriptExecutor) driver)
				.executeScript(
						"arguments[0].val‌​ue=arguments[1]",
						driver.findElement(By
								.name("proposalNotes5745fcfdbcbb29192ce0d451University_Research_Administrator")),
						"Test");
